...
def bic(X: np.ndarray, mixture: GaussianMixture,
    ...
    # compute the number of parameters in a mixture gaussian:
    # K-1 params for p, K*d for mu, K for var
    num_params = (K-1)+(K*d)+K
    
    # return BIC
    return log_likelihood - 0.5*num_params*np.log(n)
